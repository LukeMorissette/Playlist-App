...
class db_operations():
    ...
    def single_param_record(self,query,params=None):
    ...
    def single_attribute(self,query):
        ...
        results.remove(None)
        return results
    # function to return a single attribute values from table given a param
    def single_param_attribute(self, query, params=None):
        self.cursor.execute(query, params)
    ...
    #Allows user to edit current entities
    def edit_query(self, query, params=None):
        self.cursor.execute(query, params)
        self.connection.commit()
